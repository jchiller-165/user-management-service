...
public class UserDetailsMapperTest {
    ...
    void toUserDetails_mapsFieldsCorrectly() {
        ...
        assertEquals(expectedEntity.getUserId(), userDetails.getUserId());
        assertEquals(expectedEntity.getUsername(), userDetails.getUsername());
        assertEquals(expectedEntity.getFirstName(), userDetails.getFirstName());
        assertEquals(expectedEntity.getLastName(), userDetails.getLastName());
    ...
    private CompanyDetailsEntity createCompanyDetailsEntity() {
        ...
        companyDetails.setCompanyState("Tech State");
    ...
    private boolean compareCompanyDetails(CompanyDetailsEntity expected, CompanyDetails companyDetails) {
        return expected.getCompanyName()
                .equals(companyDetails.getCompanyName()) &&
                expected.getCompanyAddress()
                        .equals(companyDetails.getCompanyAddress()) &&
                expected.getCompanyCity()
                        .equals(companyDetails.getCompanyCity()) &&
                expected.getCompanyState()
                        .equals(companyDetails.getCompanyState()) &&
                expected.getCompanyPostalCode()
                        .equals(companyDetails.getCompanyPostalCode()) &&
                expected.getCompanyCountry()
                        .equals(companyDetails.getCompanyCountry());
    }

    private boolean compareContactInfo(ContactInfoEntity expected, ContactInfo contactInfo) {
        return expected.getEmail()
                .equals(contactInfo.getEmail()) &&
                expected.getPhoneNumber()
                        .equals(contactInfo.getPhoneNumber()) &&
                expected.getCity()
                        .equals(contactInfo.getCity()) &&
                expected.getState()
                        .equals(contactInfo.getState()) &&
                expected.getPostalCode()
                        .equals(contactInfo.getPostalCode()) &&
                expected.getCountry()
                        .equals(contactInfo.getCountry());
    }
