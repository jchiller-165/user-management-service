...
class UpdateUserRequestTest {
  ...
  @Test
  void testUpdateUserRequestModel() {
    UpdateUserRequest updateUserRequest = new UpdateUserRequest();
    updateUserRequest.setUsername(USERNAME);
    updateUserRequest.setUserRole(UserRole.RoleTypeEnum.ADMIN);

    assertEquals(USERNAME, updateUserRequest.getUsername());
    assertEquals(UserRole.RoleTypeEnum.ADMIN, updateUserRequest.getUserRole());
  }
