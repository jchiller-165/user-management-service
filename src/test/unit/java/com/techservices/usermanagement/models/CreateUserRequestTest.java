...
class CreateUserRequestTest {
  ...
  @Test
  void testCreateUserRequestModel() {
    CreateUserRequest createUserRequest = new CreateUserRequest();
    createUserRequest.setUsername(USERNAME);
    createUserRequest.setUserRole(UserRole.RoleTypeEnum.ADMIN);

    assertEquals(USERNAME, createUserRequest.getUsername());
    assertEquals(UserRole.RoleTypeEnum.ADMIN, createUserRequest.getUserRole());
  }
